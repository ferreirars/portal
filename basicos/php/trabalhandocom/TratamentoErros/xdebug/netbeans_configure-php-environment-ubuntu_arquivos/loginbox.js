function show_login_form(username,logintext,logouttext,where) {
   ...
   if (where == "top") {
      if(username!="guest") {
         document.write("<center><table><tr><td>Logged in as <a style=\"color: black;\" href=\"/servlets/StartPage\"><b>"+username+"</b></a><br><a href=\"http://www.netbeans.org/issues/buglist.cgi?cmdtype=runuserdefault\">Check my issues</a></td><td>&nbsp;<a href=\"/servlets/TLogout\"><img width=\"46\" height=\"15\" style=\"margin-top: 2px;\" src=\"http://www.netbeans.org/images/v4/btn_logout2.gif\"/></a></td></tr></table></center>");
      } else {
         document.write("Not logged in. <a href=\"\" onclick=\"return switch_element('comm_loginbox')\"><b>Log In</b></a>, <a href=\"http://www.netbeans.org/servlets/Join\">Register</a>");
         ...
         document.write('<tr><td colspan="2" class="align-left"><span class="font-11"><a href="http://www.netbeans.org/servlets/PasswordRequest">Forgot your password?</a></span></td></tr></table><br></form>');
         document.write("</div>");
      }
      ...
      if (username!='guest') {
         ...
         document.write('<a href="/servlets/TLogout"><img src="http://www.netbeans.org/images/v4/btn_logout2.gif" alt="" width="46" height="15" border="0" style="margin-top:5px;"></a></td></tr></table></div><br/>');
      } else {
         ...
         document.write('<td>&nbsp; <span class="font-11"><a href="http://www.netbeans.org/servlets/PasswordRequest">Forgot your password?</a></span></td></tr></table></div></form><br/>');
      }
      ...
      if (username!='guest') {
         ...
         document.write('<a href="/servlets/TLogout"><img src="http://www.netbeans.org/images/v4/btn_logout2.gif" alt="" width="46" height="15" border="0" style="margin-top:5px;"></a></td></tr></table></center>');
      } else {
         ...
         document.write('&nbsp; <span class="font-11"><a href="http://www.netbeans.org/servlets/PasswordRequest">Forgot your password?</a></span></form>');
      }
